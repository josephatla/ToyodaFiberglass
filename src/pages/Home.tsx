        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div 
              ...
              className="flex flex-col gap-6 items-start text-left z-10"
            >
        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 md:p-8 rounded-2xl shadow-xl hidden sm:block max-w-[200px] md:max-w-xs border border-blue-100">
