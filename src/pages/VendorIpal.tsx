...
export default function About() {
  ...
  return (
    <div className="flex flex-col w-full bg-blue-50/50">
      <SEO 
        title="Tentang PT Toyoda Fiber Indonesia – Vendor IPAL Sejak 2010"
        description="Profil PT Toyoda Fiber Indonesia: produsen fiberglass di Tangerang untuk IPAL, STP, dan tangki industri, bersertifikat ISO, KAN, TKDN & SNI."
        url="https://ipaltoyoda.com/tentang-kami"
      />
      <section id="header-tentang" className="relative w-full py-8 md:py-12">
        <Container>
      ...
      <section id="profil-perusahaan" className="py-16 md:py-24 bg-blue-50/50 backdrop-blur-sm">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            >
              ...
              <h2 className="text-slate-900 text-2xl sm:text-3xl md:text-4xl font-bold mb-6">PT Toyoda Fiber Indonesia</h2>
              <div className="space-y-6 text-slate-600 leading-relaxed text-base sm:text-lg">
                <p><strong>VENDOR IPAL, STP, PANELTANK, CHEMICAL TANK</strong>, dan <strong>PRODUK FIBERGLASS LAINNYA</strong><br/>Solusi Terbaik untuk Pengolahan Air dan Kebutuhan Penyimpanan Industri.</p>
                <p><strong>PT TOYODA FIBER INDONESIA</strong> merupakan vendor <strong>IPAL, STP, PANELTANK</strong>, dan <strong>CHEMICAL TANK</strong> terbaik di <strong>INDONESIA</strong>.</p>
                <p>Perusahaan kami sudah berdiri sejak tahun 2010 sehingga kami sudah sangat berpengalaman dalam hal ini, produk kami telah memenuhi standar Nasional dan Internasional dengan Sertifikasi <strong>ISO, TKDN</strong> serta <strong>SNI</strong>.</p>
                <p>Perusahaan kami didukung oleh Teknologi Modern dan Material yang sangat Berkualitas, sehingga <strong>PT TOYODA FIBER INDONESIA</strong> berkomitmen untuk memberikan sistem <strong>IPAL/STP</strong> yang efisien, ramah lingkungan, dan kami pun berkomitmen untuk <strong>CHEMICAL TANK</strong> dan <strong>PANELTANK</strong> dapat diberikan dengan hasil yang tahan lama dan kuat. Kami siap melayani berbagai kebutuhan proyek anda di seluruh <strong>INDONESIA</strong>.</p>
                <div className="pt-2">
                  <p>📞 0811 1999 777</p>
                  <p>✉️ toyodafiber.id@gmail.com</p>
                  <p>📸 Instagram: @toyodafiber.id</p>
                  <p>🌐 ipaltoyoda.com</p>
                </div>
                <p className="font-bold text-slate-800">PT. TOYODA FIBER INDONESIA — Solusi Fiberglass untuk Pengolahan Air Limbah.</p>
              </div>
      ...
      <section id="nilai-perusahaan" className="py-16 md:py-24 bg-blue-50/50">
        <Container>
          <motion.div 
